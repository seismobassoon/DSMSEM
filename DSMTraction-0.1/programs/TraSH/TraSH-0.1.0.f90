  ...
  do i=imin,imax ! each frequency        
     ...
     if ( i.ne.0 ) then
        ...
        do l = 0, maxlmax ! l-loop commence
           ...
           do itheta = 1,theta_n
              !call calbvecphi0_stock(l,theta(itheta),plmDir,bvec(1,-2,itheta),bvecdt(1,-2,itheta),bvecdp(1,-2,itheta))
                    ...
                    do imt = 2,6
                       ...
                       do ir_= 1,r_n                    
                          ...
                          !do itheta = 1, theta_n
                             ...
                             !call udertotsgtSH(imt,uder,tsgt(1:10,ir_,itheta,ir0))
